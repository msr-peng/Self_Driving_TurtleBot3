...
def get_thresholded_image(img):
    ...
    g_condition = g_condition*1

    B = img[:,:,0]
    blue_threshold = 150
    b_condition = B < blue_threshold
    combined_condition = g_condition & b_condition
    combined_condition = combined_condition*1
    ...
    thresholded = cv2.bitwise_and(combined_condition, combined_condition, mask=mask)
